...
func Router() *mux.Router {
	...
	router.HandleFunc("/workflow/{UUID}", middleware.UpdateWorkflow).Methods("PATCH", "OPTIONS")
	router.HandleFunc("/workflow/{UUID}", middleware.DeleteWorkflow).Methods("DELETE", "OPTIONS")
